...
```bash
CORPORATIVE_PIP_INDEX=https://pypi.ci.artifacts.walmart.com/artifactory/api/pypi/external-pypi/simple
CORPORATIVE_NPM_REGISTRY=https://npm.ci.artifacts.walmart.com/artifactory/api/npm/external-npm
CORPORATIVE_PROXY=http://sysproxy.wal-mart.com:8080
```
